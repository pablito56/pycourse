...
$ python exercises/mod_json/solution_timeit_json.py
...
simplejson_encoder = simplejson.JSONEncoder()
simplejson_decoder = simplejson.JSONDecoder()
...
def json_w_instance():
    ...
    """
    enc1 = json_decoder.decode(ENCODED)
    enc2 = json_decoder.decode(ENCODED)
    enc3 = json_decoder.decode(ENCODED)
    dec1 = json_encoder.encode(DATA)
    dec2 = json_encoder.encode(DATA)
    dec3 = json_encoder.encode(DATA)
...
def simplejson_w_instance():
    ...
    """
    enc1 = simplejson_decoder.decode(ENCODED)
    enc2 = simplejson_decoder.decode(ENCODED)
    enc3 = simplejson_decoder.decode(ENCODED)
    dec1 = simplejson_encoder.encode(DATA)
    dec2 = simplejson_encoder.encode(DATA)
    dec3 = simplejson_encoder.encode(DATA)
