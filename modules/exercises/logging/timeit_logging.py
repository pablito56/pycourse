...
#-*- coding: utf-8 -*-
u'''
MOD: Logging exercise: enhance performance using str.format or delegating interpolation to logging

Results in MacBook Pro 13" 2.4Ghz i5 8Gb:
$ python timeit_logging.py
...
$ python timeit_logging.py
TIMING MANUAL INTERPOLATION LOGGING (1000000 times): 7.28994
TIMING MANUAL FORMATTING LOGGING (1000000 times): 5.81181
TIMING LOGGING INTERPOLATING LOGGING (1000000 times): 4.47621
'''
